...
export class CarritoService {
  ...
  enviarDetalles(detalles: Detalle[]): Observable<any> {
    return this.http.post('http://34.95.200.214/Libreria/faces/rest/compras/detalles', detalles, {headers: this.httpHeaders});
  }

  realizarPago(detalles: Detalle[]): Observable<any> {
    console.log(detalles,' here');
    
    return this.http.post('http://34.95.200.214/Libreria/faces/rest/compras/factura', detalles, {headers: this.httpHeaders});
  }
